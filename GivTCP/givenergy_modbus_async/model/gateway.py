...
class Gateway(RegisterGetter, metaclass=DynamicDoc):            # F/W GA00009 and before
...
class Gateway2(RegisterGetter, metaclass=DynamicDoc):               #F/W GA000010 and after
    # pylint: disable=missing-class-docstring
    # The metaclass turns accesses to __doc__ into calls to
    # _gendoc()  (which we inherit from RegisterGetter)
    ...
    NEW_LUT = {
        ...
        "e_grid_import_today": Def(C.deci, None, IR(1640)),
        "e_grid_import_total": Def(C.uint32, C.deci, IR(1642),IR(1641)),    #Note swap of H and L in new Firmware
        "e_pv_today": Def(C.deci, None, IR(1643)),
        "e_pv_total": Def(C.uint32, C.deci, IR(1645),IR(1644)),    #Note swap of H and L in new Firmware
        "e_grid_export_today": Def(C.deci, None, IR(1646)),
        "e_grid_export_total": Def(C.uint32, C.deci, IR(1648),IR(1647)),    #Note swap of H and L in new Firmware
        "e_aio_charge_today": Def(C.deci, None, IR(1649)),
